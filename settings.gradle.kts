...
fun VersionCatalogBuilder.voice() {
    version("lavaplayer-devoxin", "original-SNAPSHOT")
    version("lavaplayer-arbjerg", "2.2.3")
    version("koe", "2.1.1")

    library("lavaplayer", "com.github.devoxin.lavaplayer", "lavaplayer").versionRef("lavaplayer-devoxin")
    library("lavaplayer-ip-rotator", "dev.arbjerg", "lavaplayer-ext-youtube-rotator").versionRef("lavaplayer-arbjerg")
